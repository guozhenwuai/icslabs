...
# ID: 515030910231												   #
#																   #
# 1.implement iaddl and leave instructions				           #
#   modified instr_valid ( IIADDL, ILEAVE )						   #
#			 need_regids ( IIADDL )								   #
#			 need_valC ( IADDL )								   #
#			 d_srcA ( ILEAVE )									   #
#			 d_srcB ( IIADDL, ILEAVE )							   #
#			 d_dstE ( IIADDL, ILEAVE )							   #
#			 d_dstM ( ILEAVE )									   #
#			 aluA ( IIADDL, ILEAVE )							   #
#			 aluB ( IIADDL, ILEAVE )							   #
#			 set_CC ( IIADDL )									   #
...
#			 D_bubble ( ILEAVE )								   #
#			 E_bubble ( ILEAVE )								   #
# 2.eliminate the bubble after ret when the instruction is followed#
#	by push instruction											   #
#	modified f_pc F_stall D_bubble								   #
#																   #
####################################################################
...
int f_pc = [
	...
	# Deal with the push(E) ret(D) case.
...
bool F_stall =
	...
	# and the instruction before ret is not push
